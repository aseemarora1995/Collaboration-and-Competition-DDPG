...
For this project, the main file is `Tennis.ipynb`. 
Run the command `jupyter-notebook`, from the `p3_collab-compet/` folder, to use `Jupyter Notebook` and open `Tennis.ipynb`.
